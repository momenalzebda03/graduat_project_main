...
$checkQuery = "SELECT * FROM `table_message` WHERE `id_vocational` = :number1 AND `id_customer` = :number2";
...
if ($existingCount > 0) {
    $insertQuery = "INSERT INTO `table_message`(`id_vocational`, `id_customer`, `message_customer`) VALUES (:number1, :number2, :message)";
