    ...
    <section class="container pt-4 my-5">
        <div class="text-center">
            <h2 class="fw-bold" :style="{ color: textColor }">أرسل رسالة إلى المهني الذي تريده
                <br><span class="p_color_blue">{{ api_user1.Customer_Name }}</span>
            </h2>
        </div>
        <div class="row">
            <div class="col-12 col-lg-4">
                <div class="d-flex justify-content-center position-relative">
                    <img :src="getImagePath(api_user1.Customer_Image)"
                    ...
                    <button @click="button_block"
                        ...
                        رسالة</button>
                    <textarea required v-model="text_message" class="position-absolute text_top rounded-3 ps-1 pt-1"
...
export default {
    ...
    created() {
        this.changePageTitle('تواصل - العميل');
    },
    mounted() {
