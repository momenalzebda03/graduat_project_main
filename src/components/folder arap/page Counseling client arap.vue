...
export default {
    ...
    methods: {
        ...
        getLink(my_id) {
            ...
            return `http://localhost/graduatproject-main/src/components/folder%20arap/update%20cpunseling%20client%20arap.php?id=${this.$route.params.id}_${my_id}&text_message=${encodedTextMessage}`;
        },
